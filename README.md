...
```
Detecção de Deadlock com várias recursos de cada tipo
Algoritmo baseado numa matriz para detecção de deadlock com n
processos e m classes de recursos diferentes, com Ei recursos da classe i,
sendo (1 <= i <= m).
